        ...
        children: [
          InkWell(
            ...
            child: Container(
              ...
              child: Text(
                  '13/4/24',
                  style: MyTextStyles.boldTextStyle24.copyWith(
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: const Icon(FontAwesomeIcons.caretDown,
                color: MyColors.kPrimaryColor, size: 28,),
            ),
          ),
          const Spacer(),
          SizedBox(
            ...
            height: 49,
            child: CustomButton(
              textStyle: MyTextStyles.boldTextStyle18.copyWith(
                  color: Colors.white
              ),
              text: 'Submit',
